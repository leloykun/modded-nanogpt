...
optimizer1 = torch.optim.Adam([raw_model.transformer.wte.weight] + list(raw_model.transformer.vte.parameters()), lr=0.6, betas=(0.8, 0.95), fused=True)
...
for step in range(args.num_iterations + 1):
    ...
    print0(f"step:{step+1}/{args.num_iterations} train_loss:{loss.detach().item():.4f} train_time:{approx_time:.0f}ms step_avg:{approx_time/timed_steps:.2f}ms")
