...
def zeropower_via_newtonschulz5(G: Tensor, steps: int) -> Tensor:
    ...
    for a, b, c in [
        (3.8165, -3.8897, 1.0732),
        (3.6622, -3.7354, 1.0732),
        (3.5112, -3.5840, 1.0728),
        (3.3655, -3.4381, 1.0727),
        (3.2216, -3.2930, 1.0714),
        (3.0840, -3.1550, 1.0709),
        (2.9224, -2.9771, 1.0548),
        (2.7773, -2.8210, 1.0436),
    ]:
        A = X @ X.mT
