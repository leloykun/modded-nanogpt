...
def zeropower_via_newtonschulz5(G: Tensor, steps: int) -> Tensor:
    ...
    for a, b, c in [
        (3.8795, -3.9940, 1.1145),
        (3.8755, -3.9895, 1.1140),
        (3.8640, -3.9737, 1.1096),
        (3.8547, -3.9635, 1.1087),
        (3.6919, -3.7446, 1.0527),
        (3.2471, -3.1889, 0.9418),
        (2.8273, -2.7611, 0.9337),
        (2.6441, -2.5610, 0.9169),
    ]:
        A = X @ X.mT
