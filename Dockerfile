...
RUN pip install --pre torch==2.7.0.dev20250125+cu126 --index-url https://download.pytorch.org/whl/nightly/cu126 --upgrade
RUN python data/cached_fineweb10B.py 40
